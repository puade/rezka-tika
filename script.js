    ...
    // Countdown function
    function countdown() {
      const countDate = new Date("February 20, 2025 09:00:00").getTime();
...
function fetchUcapan() {
  var url = 'https://script.google.com/macros/s/AKfycbxLeYOM9FfsUlV3jHvEOpd-heJFSxzrC26c61GJPppBQS6tAXe1-wm5ZOKSFJv6QWefCA/exec'; // Ganti dengan URL Web App Google Apps Script Anda
...
document.getElementById('formPernikahan').addEventListener('submit', function(event) {
  ...
  fetch('https://script.google.com/macros/s/AKfycbxLeYOM9FfsUlV3jHvEOpd-heJFSxzrC26c61GJPppBQS6tAXe1-wm5ZOKSFJv6QWefCA/exec', {
    method: 'POST',
